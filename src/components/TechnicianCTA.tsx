        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-on-scroll">
              ...
              <Button 
                size="lg"
                className="bg-secondary text-secondary-foreground hover:bg-secondary/90 shadow-lg px-8 py-6 text-lg"
              ...
              <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-3xl p-8 border border-primary-foreground/20">
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center p-4">
                    ...
                    <div className="text-sm opacity-80">فني نشط</div>
                  </div>
                  <div className="text-center p-4">
                    <div className="text-4xl font-bold text-secondary mb-2">+15</div>
                    <div className="text-sm opacity-80">فرع في مصر</div>
                  </div>
                  <div className="text-center p-4">
